...
namespace Epic.OnlineServices.Lobby
{
	...
	public struct JoinLobbyByIdOptions
	{
		...
		/// <summary>
		/// If <see langword="true" />, this lobby will be associated with the user's presence information. A user can only associate one lobby at a time with their presence information.
	...
	internal struct JoinLobbyByIdOptionsInternal : ISettable<JoinLobbyByIdOptions>
	{
		...
		public void Set(ref JoinLobbyByIdOptions other)
		{
			...
			m_ApiVersion = LobbyInterface.JOINLOBBYBYID_API_LATEST;
