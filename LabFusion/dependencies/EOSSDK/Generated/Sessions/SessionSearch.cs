...
namespace Epic.OnlineServices.Sessions
{
	public sealed partial class SessionSearch : Handle
	{
		...
		{
			var optionsInternal = default(SessionSearchCopySearchResultByIndexOptionsInternal);
			optionsInternal.Set(ref options);

			var outSessionHandleInnerHandle = IntPtr.Zero;

			var callResult = Bindings.EOS_SessionSearch_CopySearchResultByIndex(InnerHandle, ref optionsInternal, out outSessionHandleInnerHandle);
		...
		public void Find(ref SessionSearchFindOptions options, object clientData, SessionSearchOnFindCallback completionDelegate)
		{
			...
			var optionsInternal = default(SessionSearchFindOptionsInternal);
			optionsInternal.Set(ref options);
			...
			Bindings.EOS_SessionSearch_Find(InnerHandle, ref optionsInternal, clientDataPointer, SessionSearchOnFindCallbackInternalImplementation.Delegate);
		...
		{
			var optionsInternal = default(SessionSearchGetSearchResultCountOptionsInternal);
			optionsInternal.Set(ref options);

			var callResult = Bindings.EOS_SessionSearch_GetSearchResultCount(InnerHandle, ref optionsInternal);
		...
		/// <see cref="SessionsInterface.CreateSessionSearch" />
		/// </summary>
		/// <param name="sessionSearchHandle">
		/// - The session search handle to release
		/// </param>
		public void Release()
		{
		...
		{
			var optionsInternal = default(SessionSearchRemoveParameterOptionsInternal);
			optionsInternal.Set(ref options);

			var callResult = Bindings.EOS_SessionSearch_RemoveParameter(InnerHandle, ref optionsInternal);
		...
		{
			var optionsInternal = default(SessionSearchSetMaxResultsOptionsInternal);
			optionsInternal.Set(ref options);

			var callResult = Bindings.EOS_SessionSearch_SetMaxResults(InnerHandle, ref optionsInternal);
		...
		{
			var optionsInternal = default(SessionSearchSetParameterOptionsInternal);
			optionsInternal.Set(ref options);

			var callResult = Bindings.EOS_SessionSearch_SetParameter(InnerHandle, ref optionsInternal);
		...
		{
			var optionsInternal = default(SessionSearchSetSessionIdOptionsInternal);
			optionsInternal.Set(ref options);

			var callResult = Bindings.EOS_SessionSearch_SetSessionId(InnerHandle, ref optionsInternal);
		...
		{
			var optionsInternal = default(SessionSearchSetTargetUserIdOptionsInternal);
			optionsInternal.Set(ref options);

			var callResult = Bindings.EOS_SessionSearch_SetTargetUserId(InnerHandle, ref optionsInternal);
