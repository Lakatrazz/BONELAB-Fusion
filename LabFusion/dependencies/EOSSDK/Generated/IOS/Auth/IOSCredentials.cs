...
{
	/// <summary>
	/// Login credentials filled as part of the <see cref="IOSLoginOptions" /> struct for <see cref="AuthInterface.Login" /> API.
	/// 
	...
	internal struct IOSCredentialsInternal : ISettable<IOSCredentials>
	{
		...
		public void Set(ref IOSCredentials other)
		{
			...
			m_Type = other.Type;
			Helper.Set<IOSCredentialsSystemAuthCredentialsOptions, IOSCredentialsSystemAuthCredentialsOptionsInternal>(other.SystemAuthCredentialsOptions, ref m_SystemAuthCredentialsOptions);
