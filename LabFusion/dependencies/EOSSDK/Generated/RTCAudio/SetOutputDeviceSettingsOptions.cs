...
namespace Epic.OnlineServices.RTCAudio
{
	...
	public struct SetOutputDeviceSettingsOptions
	{
		...
		/// <summary>
		/// The device Id to be used for this user. Pass <see langword="null" /> or empty <see cref="Utf8String" /> to use a default output device.
		/// 
	...
	internal struct SetOutputDeviceSettingsOptionsInternal : ISettable<SetOutputDeviceSettingsOptions>
	{
		...
		public void Set(ref SetOutputDeviceSettingsOptions other)
		{
			...
			m_ApiVersion = RTCAudioInterface.SETOUTPUTDEVICESETTINGS_API_LATEST;
