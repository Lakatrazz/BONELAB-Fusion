...
namespace Epic.OnlineServices.TitleStorage
{
	public sealed partial class TitleStorageFileTransferRequest : Handle
	{
		...
		{
			var callResult = Bindings.EOS_TitleStorageFileTransferRequest_CancelRequest(InnerHandle);
		...
		{
			var callResult = Bindings.EOS_TitleStorageFileTransferRequest_GetFileRequestState(InnerHandle);
		...
		/// <see cref="TitleStorageInterface.FILENAME_MAX_LENGTH_BYTES" />
		/// </summary>
		...
		{
			int outStringLength = TitleStorageInterface.FILENAME_MAX_LENGTH_BYTES;
			var outStringBufferPointer = Helper.AddAllocation(outStringLength);

			var callResult = Bindings.EOS_TitleStorageFileTransferRequest_GetFilename(InnerHandle, (uint)outStringLength, outStringBufferPointer, out outStringLength);
