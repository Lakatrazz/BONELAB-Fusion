...
namespace Epic.OnlineServices.PlayerDataStorage
{
	...
	public struct FileMetadata
	{
		...
		/// <summary>
		/// The POSIX timestamp when the file was saved last time or <see cref="PlayerDataStorageInterface.TIME_UNDEFINED" /> if the time is undefined.
	...
	internal struct FileMetadataInternal : IGettable<FileMetadata>
	{
		...
		public void Get(out FileMetadata other)
		{
			...
			DateTimeOffset? LastModifiedTimePublic;
			Helper.Get(m_LastModifiedTime, out LastModifiedTimePublic);
			other.LastModifiedTime = LastModifiedTimePublic;
