...
namespace Epic.OnlineServices.P2P
{
	...
	/// 
	/// +------------------------------+---------------------+-------------------------------+---------------------+
	/// | | <see cref="NoRelays" /> | <see cref="AllowRelays" /> (Default) | <see cref="ForceRelays" /> |
	/// +------------------------------+---------------------+-------------------------------+---------------------+
	/// | <see cref="NoRelays" /> | Compatible | Compatible | Incompatible |
	/// | <see cref="AllowRelays" /> (Default) | Compatible | Compatible | Compatible |
	/// | <see cref="ForceRelays" /> | Incompatible | Compatible | Compatible |
	/// +------------------------------+---------------------+-------------------------------+---------------------+
	/// </summary>
