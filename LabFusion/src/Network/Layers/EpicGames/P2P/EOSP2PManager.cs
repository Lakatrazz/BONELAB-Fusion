...
internal class EOSP2PManager
{
    ...
    internal EOSP2PManager(ProductUserId localUserId, SocketId socketId)
    {
    ...
    internal Result AcceptConnection(ProductUserId remoteUserId)
    {
    ...
    internal Result CloseConnection(ProductUserId remoteUserId)
    {
        if (EOSInterfaces.P2P == null || remoteUserId == null)
            return Result.InvalidState;
    ...
    internal Result CloseAllConnections()
    {
        if (EOSInterfaces.P2P == null)
            return Result.InvalidState;
