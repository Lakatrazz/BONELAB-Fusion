...
internal class EOSPacketReceiver
{
    ...
    internal EOSPacketReceiver(EOSBufferPool bufferPool, SocketId socketId)
    {
    ...
    private readonly struct ReceivedPacket
    {
        ...
        internal readonly ProductUserId PeerId;
        internal readonly bool IsServerHandled;

        internal ReceivedPacket(byte[] buffer, int bytesWritten, ProductUserId peerId, bool isServerHandled)
        {
            Buffer = buffer;
