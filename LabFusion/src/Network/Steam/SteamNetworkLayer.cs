...
namespace LabFusion.Network
{
    public abstract class SteamNetworkLayer : NetworkLayer
    {
        ...
        protected bool _isConnectionActive;
...
#pragma warning restore CS0162 // Unreachable code detected
        ...
        internal override void BroadcastMessage(NetworkChannel channel, FusionMessage message)
        {
            if (IsServer)
            {
                SteamSocket.BroadcastToClients(channel, message);
            }
            else
            {
        ...
        {
            SteamSocket = SteamNetworkingSockets.CreateRelaySocket<SteamSocketManager>();
        ...
        public void JoinServer(SteamId serverId)
        {
            ...
            SteamConnection = SteamNetworkingSockets.ConnectRelay<SteamConnectionManager>(serverId);
        ...
        private bool _isPublicLobbySearching;
        ...
        private bool _isFriendLobbySearching;
