...
public abstract class EntityComponentParentExtender<TComponent> : IEntityComponentExtender where TComponent : Component
{
    ...
    public bool TryRegister(NetworkEntity networkEntity, GameObject[] parents)
    {
        ...
        {
            var component = parent.GetComponentInParent<TComponent>(true);
