...
namespace LabFusion.Extensions
{
    public static class IEnumerableExtensions
    {
        ...
        public static bool Has<T>(this IEnumerable<T> list, T obj) where T : Object => list.Any(o => o == obj);

        public static bool Has<T>(this Il2CppSystem.Collections.Generic.List<T> list, T obj) where T : Object
        {
            for (var i = 0; i < list.Count; i++)
            {
                var other = list[i];
