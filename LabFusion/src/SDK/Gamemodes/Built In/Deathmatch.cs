...
public class Deathmatch : Gamemode
{
    ...
    protected static void OnVictoryStatus(bool isVictory = false)
    {
        ...
        dataCard.AudioClip.LoadAsset((Il2CppSystem.Action<AudioClip>)((c) => {
            var volume = new BoxedNullable<float>(Audio3dManager.audio_MusicVolume);
            var pitch = new BoxedNullable<float>(null);
            Audio3dManager.Play2dOneShot(c, Audio3dManager.nonDiegeticMusic, volume, pitch);
        }));
    }
