...
namespace LabFusion.SDK.Gamemodes
{
    public class TeamDeathmatch : Gamemode
    {
        ...
        public bool OverrideValues => _overrideValues;
        ...
        private string _avatarOverride;
        private float? _vitalityOverride;
        ...
        private int GetRewardedBits()
        {
            ...
            float playerPercent = playerCount / 4f;
            ...
            float percent = ManagedMathf.Clamp01(score / (float)totalScore);
            int reward = ManagedMathf.FloorToInt(maxBits * percent);

            // Add randomness
            reward += Random.Range(-maxRand, maxRand);
        ...
        protected void AssignTeam(PlayerId id)
        {
            ...
            Team newTeam = teamPool[Random.Range(0, teamPool.Count)];
