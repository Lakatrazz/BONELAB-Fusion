...
namespace LabFusion.Utilities
{
    public static class LaserCursorUtilities
    {
        public static LaserCursor CreateLaserCursor(Action<LaserCursor> onSetupRegions = null)
        {
            ...
            var growCurve = new AnimationCurve(new[]
            {
                new Keyframe(0f, 1f),
            ...
            prismaticSFX.modulatedClips = new[] { FusionContentLoader.LaserPrismaticSFX };
            ...
            cursor.pulseSound = new[] { FusionContentLoader.LaserPulseSound };
            cursor.raySpawn = new[] { FusionContentLoader.LaserRaySpawn };
            cursor.rayDespawn = new[] { FusionContentLoader.LaserRayDespawn };
        ...
        private static PageElementView SetupPageElementView(this Transform transform)
        {
            ...
            pageElementView.elements = new[] { highlightUI };
