...
public static class EOSSDKLoader
{
    ...
    {
        byte[] embeddedBytes = EmbeddedResource.LoadBytesFromAssembly(FusionMod.FusionAssembly, PlatformHelper.IsAndroid ? ResourcePaths.EOSSDKAndroidPath : ResourcePaths.EOSSDKWindowsPath);
