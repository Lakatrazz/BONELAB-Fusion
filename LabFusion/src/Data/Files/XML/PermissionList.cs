...
public static class PermissionList
{
    ...
    public static void SetPermission(string platformID, string username, PermissionLevel level)
    {
        var tuple = new Tuple<string, string, PermissionLevel>(platformID, username, level);
