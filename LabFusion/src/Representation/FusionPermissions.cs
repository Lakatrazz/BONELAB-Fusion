...
public static class FusionPermissions
{
    ...
    public static void FetchPermissionLevel(ClientPlatformID platformID, out PermissionLevel level, out Color color)
    {
    ...
    public static void TrySetPermission(ClientPlatformID platformID, string username, PermissionLevel level)
    {
        // Set in file
