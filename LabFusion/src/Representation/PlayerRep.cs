...
namespace LabFusion.Representation
{
    public class PlayerRep : IDisposable
    {
        ...
        public static Transform[] syncedPoints;
        public static Transform[] gameworldPoints;
        ...
        public SerializedBodyVitals vitals;
        public SerializedAvatarStats avatarStats;
        public SerializedPlayerSettings playerSettings;
        ...
        private bool _isVitalsDirty;

        private bool _isRagdollDirty;
        private bool _ragdollState;

        private bool _isSettingsDirty;
        private bool _isServerDirty;

        private bool _isQuestUser;
        ...
        private float _voiceUpdateTime;
        ...
        public void PlayPullCordEffects()
        {
            ...
            pullCord.PlayClip(pullCord.switchAvatar, pullCord.ap3, pullCord.switchVolume, 4f);
        }
