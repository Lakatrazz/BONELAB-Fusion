...
Shader "SLZ/Simple Geo Skybox"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEEnd][ASEBegin][HDR][NoScaleOffset]_BaseMap("BaseMap", CUBE) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				half4 texCUBENode5 = texCUBElod( _BaseMap, float4( -ase_worldViewDir, 0.0) );
				
				half3 BakedAlbedo = 0;
				half3 BakedEmission = 0;
				half3 Color = texCUBENode5.rgb;
				half Alpha = 1;
		...
		Pass
		{
			...
			HLSLPROGRAM
#pragma multi_compile_instancing#define _RECEIVE_SHADOWS_OFF 1#pragma multi_compile_fog#define ASE_FOG 1#pragma multi_compile_fragment _ _VOLUMETRICS_ENABLED#define ASE_SRP_VERSION 999999
#if FALSE
			#pragma multi_compile _ LIGHTMAP_ON
			#pragma multi_compile _ DIRLIGHTMAP_COMBINED
			#pragma shader_feature _ _SAMPLE_GI
