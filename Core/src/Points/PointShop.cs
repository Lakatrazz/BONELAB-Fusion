...
namespace LabFusion.Points
{
    ...
    public sealed class PointShop : MonoBehaviour {
        ...
        public void Awake() {
            ...
            // Get grip pose
            if (_gripPose == null)
                _gripPose = Resources.FindObjectsOfTypeAll<HandPose>()[0];
    ...
    public sealed class PointShopUITrigger : MonoBehaviour {
        ...
        private void Click() {
            ...
            FusionAudio.Play3D(transform.position, FusionBundleLoader.UIConfirm, 0.7f);
        }
        ...
        private void Select(Hand hand) {
            ...
            FusionAudio.Play3D(transform.position, FusionBundleLoader.UISelect, 0.7f);
        }
