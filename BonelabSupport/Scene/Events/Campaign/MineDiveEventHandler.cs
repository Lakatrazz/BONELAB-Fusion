...
namespace MarrowFusion.Bonelab.Scene;
...
public class MineDiveEventHandler : GamemodeLevelEventHandler
{
    ...
    private static void GetCartReferences()
    {
        ...
        {
            BonelabModule.Logger.Warn($"Could not find the Entrance Doors in MineDive, please report this to {FusionMod.ModAuthor}!");
        }
        ...
        {
            BonelabModule.Logger.Warn($"Could not find the Primary Minecart GameObject in MineDive, please report this to {FusionMod.ModAuthor}!");
        }
        ...
        {
            BonelabModule.Logger.Warn($"Could not find the Secondary Minecart GameObject in MineDive, please report this to {FusionMod.ModAuthor}!");
        }
    }
